...
| [`10_inheritance_and_relay_bootstrap`](https://github.com/MeRuslan/strawberry-chemist/tree/main/examples/10_inheritance_and_relay_bootstrap) | subclassed Chemist base inheritance, plain mixin caveats, complex node inheritance, preserving explicit non-node types across relay bootstrap |
