...
| Relay IDs and nodes | `@sc.node`, `sc.node_field`, `sc.Node`, `sc.relay.configure(...)` | Register node types and resolve them through stable relay IDs | [`04_nodes_and_relay_ids`](https://github.com/MeRuslan/strawberry-chemist/tree/main/examples/04_nodes_and_relay_ids) |
