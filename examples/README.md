...
| `10_inheritance_and_relay_bootstrap` | subclassed Chemist base types, plain mixin caveats for inherited `@sc.field` / `@sc.relationship`, complex node inheritance, and explicit schema reachability for detached non-node `types=(...)` entries |
